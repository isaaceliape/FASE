...
Números de wave são pré-computados durante o planejamento. Execute-fase lê `wave` diretamente do frontmatter.
...
- `fase`, `plan`, `type`, `wave`, `depends_on`, `files_modified`, `autonomous`, `must_haves`
